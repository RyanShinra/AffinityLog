...
def upgrade() -> None:
    ...
    # add_column does NOT auto-emit CREATE TYPE (unlike create_table in 001) — make the type first.
    provenance_enum: Final[pg.ENUM] = pg.ENUM(*PROVENANCE_ENUM_VALUES, name=PROVENANCE_ENUM_NAME)
    ...
    op.add_column(
        ...
        sa.Column(
            ...
            sa.Enum(*PROVENANCE_ENUM_VALUES, name=PROVENANCE_ENUM_NAME, create_type=False),
